...
class LevelDBCursor : public Cursor {
 public:
  ...
  // lingni added dummy function to hold the shuffle version from LMDB
  // notice that we do not support shuffling of levelDB
  virtual void SeekOneByKey() {iter_->Next();}
 private:
